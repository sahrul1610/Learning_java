...
/**
 * Created By : Sahrul Fazri Udin
 * Created At : 10.30 Kamis, 1 Februari 2024
 */

public class GajiPNSSahrulFU {
    ...
    static int validateMasaKerja(Scanner scanner) {
        int masaKerja;
        String regexMasaKerja = "^[1-9]\\d?$|50";
    ...
    static String validateStatusPernikahan(Scanner scanner) {
        ...
        do {
            ...
            if (statusPernikahan.matches(regexPernikahan)) {
                ...
                System.out.println(
                        "Masukkan status pernikahan yang valid (Kawin, Belum Kawin, Cerai). Coba input ulang.");
                System.out.print("Status Pernikahan (Kawin, Belum Kawin, Cerai): ");
            }
        } while (true);
    ...
    static int kalkulasiGajiPokok(int masaKerja, String tipeGolongan, int golonganPangkat) {
        ...
        int indexGolongan = golonganPangkat - 1;
        int indexTipeGolongan = tipeGolongan.charAt(0) - 'A';
        // System.out.println(indexTipeGolongan);
        int indexMasaKerja = Math.min(masaKerja, gajiPokokArray[indexGolongan].length - 1);
        // System.out.println(indexMasaKerja);
        // System.out.println(gajiPokokArray[indexGolongan][indexMasaKerja][indexTipeGolongan]);
        // // diambil dari data

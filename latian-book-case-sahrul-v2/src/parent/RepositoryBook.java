...
public class RepositoryBook {
    ...
    public List<Author> getAllAuthors() {
        ...
        List<Mangaka> allMangaka = new ArrayList<>();
        List<Novelis> allNovelis = new ArrayList<>();
        allAuthors.addAll(authors);
        allAuthors.addAll(allMangaka);
        allAuthors.addAll(allNovelis);
        return allAuthors;
    }
    ...
    public void initializeDummyData() {
        ...
        CommercialBook ebook2 = new EBook("Book - 002", "Head First Java: Your Brain on Java - A Learner's Guide",
                author2, publishers8);
        ...
        CommercialBook novel8 = new Novel("Novel - 008", "The Abbey Mystery",
        novelis5, publishers7, "Fiction");
    ...
    // //List<Publisher> publishers = getAllPublisher();
    ...
    // Mangaka mangaka1 = new Mangaka("Masashi", "Kisimoto", "Japan", 48, "Best
    // Seller");
    // Mangaka mangaka2 = new Mangaka("Yoshihiro", "Togashi", "Japan", 56, "Good");
    // Mangaka mangaka3 = new Mangaka("Eiichiro", "Oda", "Japan", 57, "Best
    // Seller");
    // Mangaka mangaka4 = new Mangaka("Rizki", "Anwar", "Indonesia", 25, "New
    // Commer");
    // Mangaka mangaka5 = new Mangaka("Yusuf", "Fadli", "Indonesia", 32, "New
    // Commer");

    // // Dummy data untuk novelists
    // Novelis novelis1 = new Novelis("J.K", "Rowling", "England", 57, true, "Best
    // Seller");
    // Novelis novelis2 = new Novelis("Tere", "Liye", "Indonesia", 35, true, "Best
    // Seller");
    // Novelis novelis3 = new Novelis("Dee", "Lestari", "Indonesia", 30, true,
    // "Good");
    // Novelis novelis4 = new Novelis("Faisal", "Syahreza", "Indonesia", 40, true,
    // "New Commer");
    // Novelis novelis5 = new Novelis("Julia", "Golding", "England", 41, false,
    // "Best Seller");
    ...
    // CommercialBook ebook1 = new EBook("Book - 001", "Memahami Hamka", author1,
    // publishers.get(2));
    // CommercialBook ebook2 = new EBook("Book - 002", "Head First Java: Your Brain
    // on Java - A Learner's Guide",
    // author2, publishers.get(7));
    // CommercialBook ebook3 = new EBook("Book - 003", "Java For Dummies", author3,
    // publishers.get(7));
    // CommercialBook ebook4 = new EBook("Book - 004", "Flutter For Dummies",
    // author3, publishers.get(7));
    // CommercialBook ebook5 = new EBook("Book - 005", "The Subtle Art of Not
    // Giving", author4, publishers.get(8));
    // CommercialBook ebook6 = new EBook("Book - 006", "Will", author4,
    // publishers.get(8));
    // CommercialBook ebook7 = new EBook("Book - 007", "Sejarah Indonesia", author5,
    // publishers.get(5));
    // CommercialBook ebook8 = new EBook("Book - 008", "Teknologi Baru", author6,
    // publishers.get(4));

    // CommercialBook novel1 = new Novel("Novel - 001", "Harry Potter and the
    // Philosopher's Stone", novelis1,
    // publishers.get(0), "Fantasy");
    // CommercialBook novel2 = new Novel("Novel - 002", "Harry Potter and the
    // Chamber of Secrets", novelis1,
    // publishers.get(0), "Fantasy");
    // CommercialBook novel3 = new Novel("Novel - 003", "Harry Potter and the
    // Prisoner of Azkaban", novelis1,
    // publishers.get(0), "Fantasy");
    // CommercialBook novel4 = new Novel("Novel - 004", "Ayah Aku Berbeda",
    // novelis2, publishers.get(1), "Drama");
    // CommercialBook novel5 = new Novel("Novel - 005", "Madre", novelis3,
    // publishers.get(1), "Drama");
    // CommercialBook novel6 = new Novel("Novel - 006", "Lagu untuk Renjana",
    // novelis4, publishers.get(2), "Drama");
    // CommercialBook novel7 = new Novel("Novel - 007", "Semoga Lekas Lega",
    // novelis4, publishers.get(2), "Drama");
    // CommercialBook novel8 = new Novel("Novel - 008", "The Abbey Mystery",
    // novelis5, publishers.get(6), "Fiction");

    // CommercialBook comic1 = new Comic("Comic - 001", "Uzumaki Naruto", mangaka1,
    // publishers.get(3), true);
    // CommercialBook comic2 = new Comic("Comic - 002", "The Worst Client",
    // mangaka1, publishers.get(3), true);
    // CommercialBook comic3 = new Comic("Comic - 003", "For the Sake of
    // Dreams...!!", mangaka1, publishers.get(3),
    // true);
    // CommercialBook comic4 = new Comic("Comic - 004", "Hunter X Hunter : The Day
    // of Departure", mangaka2,
    // publishers.get(3), true);
    // CommercialBook comic5 = new Comic("Comic - 005", "Hunter X Hunter : A
    // Struggle in the Mist", mangaka2,
    // publishers.get(3), true);
    // CommercialBook comic6 = new Comic("Comic - 006", "One Piece", mangaka3,
    // publishers.get(1), true);
    // CommercialBook comic7 = new Comic("Comic - 007", "Petualangan di Indonesia",
    // mangaka4, publishers.get(5),
    // false);
    // CommercialBook comic8 = new Comic("Comic - 008", "Petualangan di Jakarta",
    // mangaka5, publishers.get(4), false);
